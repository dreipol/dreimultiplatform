...
data class SharedPreferencesKeyValueStore(val sharedPreferences: SharedPreferences) : PersistentKeyValueStore {
    ...
    override fun getString(forKey: String): String? = sharedPreferences.getString(forKey, null)

    override fun storeBoolean(
        value: Boolean,
        forKey: String,
    ) = sharedPreferences.edit {
    ...
    override fun getInt(forKey: String): Int? = if (sharedPreferences.contains(forKey)) sharedPreferences.getInt(forKey, 0) else null
    ...
    override fun getLong(forKey: String): Long? = if (sharedPreferences.contains(forKey)) sharedPreferences.getLong(forKey, 0) else null

    override fun storeFloat(
        value: Float,
        forKey: String,
    ) = sharedPreferences.edit {
